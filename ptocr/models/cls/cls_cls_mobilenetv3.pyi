...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        batch_size = 512
        num_workers:4 = 8
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),ClsLabelEncode():...,BaseDataAugmentation():,RandAugment():,ClsResizeImg(image_shape=[3, 48, 192]),KeepKeys("image","label"):...]