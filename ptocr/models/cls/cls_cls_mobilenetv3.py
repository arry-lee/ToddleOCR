...
class Model(ConfigModel):
    ...
    class Train:
        Dataset = _(SimpleDataSet, root="./train_data/cls", label_file_list=['./train_data/cls/train.txt'])
    ...
    class Eval:
        Dataset = _(SimpleDataSet, root="./train_data/cls", label_file_list=['./train_data/cls/test.txt'])
