...
from ptocr.transforms.label_ops import TableLabelEncode, TableBoxEncode
...
class Model(ConfigModel):
    ...
    Head = _(
        TableAttentionHead, hidden_size=256, max_text_length=500, loc_reg_num=4
    )
    ...
    class Train:
        ...
        DATALOADER = _(
            shuffle=True, batch_size=48, drop_last=True, num_workers=1
        )
    ...
    class Eval:
        ...
        DATALOADER = _(
            shuffle=False, drop_last=False, batch_size=48, num_workers=1
        )
