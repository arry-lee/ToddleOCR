...
from ptocr.transforms.operators import DecodeImage, NormalizeImage, KeepKeys, E2EResizeForTest, ToCHWImage
...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        batch_size:1 = 14
        num_workers:2 = 16
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),E2ELabelEncodeTrain()::...,PGProcessTrain(batch_size=14, use_resize=True, use_random_crop=False, min_crop_size=24, min_text_size=4, max_text_size=512, point_gather_mode="align"):,:E2ELabelEncodeTest():...,:E2EResizeForTest(max_side_len=768),:NormalizeImage(scale="1./255.", mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225], order="hwc"),:ToCHWImage(),KeepKeys("images","tcl_maps","tcl_label_maps","border_maps","direction_maps","training_masks","label_list","pos_list","pos_mask"):KeepKeys("image","shape","polys","texts","ignore_tags","img_id"):...]