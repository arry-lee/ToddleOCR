...
class Model(ConfigModel):
    ...
    algorithm = 'CRNN'
    Transform = None
    Backbone = _(MobileNetV3Rec, scale=0.5, model_name="small", small_stride=[1, 2, 2, 2])
    ...
    class Loader:
        ...
        batch_size = 256
        num_workers = 8
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),RecAug():,CTCLabelEncode():...,RecResizeImg(image_shape=[3, 32, 320]),KeepKeys("image","label","length"):...]