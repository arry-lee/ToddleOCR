...
from ptocr.transforms.rec_img_aug import VLRecResizeImg, ABINetRecAug
...
class Model(ConfigModel):
    ...
    class Train:
        ...
        DATALOADER = _(
            shuffle=True, batch_size=220, drop_last=True, num_workers=4
        )
    ...
    class Eval:
        ...
        DATALOADER = _(
            shuffle=False, drop_last=False, batch_size=64, num_workers=4
        )
