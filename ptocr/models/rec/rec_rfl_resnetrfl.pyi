...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        batch_size:256 = 64
        num_workers = 8
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),RFLLabelEncode():...,RFLRecResizeImg(image_shape=[1, 32, 100], padding=False, interpolation=2),KeepKeys("image","label","length","cnt_label"):...]