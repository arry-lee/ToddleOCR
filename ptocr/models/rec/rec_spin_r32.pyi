...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        batch_size = 8
        num_workers:2 = 4
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),SPINLabelEncode():...,SPINRecResizeImg(image_shape=[100, 32], interpolation=2, mean=[127.5], std=[127.5]),KeepKeys("image","label","length"):...]