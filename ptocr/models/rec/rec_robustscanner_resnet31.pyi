...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        num_workers:4 = 8
        pin_memory = False
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),SARLabelEncode():...,RobustScannerRecResizeImg(image_shape=[3, 48, 48, 160], width_downsample_ratio=0.25, max_text_length=40):RobustScannerRecResizeImg(image_shape=[3, 48, 48, 160], max_text_length=40, width_downsample_ratio=0.25),KeepKeys("image","label","valid_ratio","word_positons"):...]