...
class Model(ConfigModel):
    ...
    Head = _(
        CTCHead, out_channels=len(postprocessor.character), fc_decay=4e-05
    )
    ...
    class Train:
        ...
        transforms = _[
            ...
            RecResizeImg(image_shape=[3, 32, 320],character_dict_path="ptocr/utils/ppocr_keys_v1.txt",),
    ...
    class Infer:
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False),
            RecResizeImg(image_shape=[3, 32, 320],infer_mode=True,character_dict_path="ptocr/utils/ppocr_keys_v1.txt"),
