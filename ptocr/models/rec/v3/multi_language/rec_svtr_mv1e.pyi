...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        batch_size = 128
        num_workers = 4
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),RecConAug(prob=0.5, ext_data_num=2, image_shape=[48, 320, 3]):,RecAug():,MultiLabelEncode():...,RecResizeImg(image_shape=[3, 48, 320]),KeepKeys("image","label_ctc","label_sar","length","valid_ratio"):...]
