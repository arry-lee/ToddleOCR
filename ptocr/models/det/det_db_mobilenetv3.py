...
class Model(ConfigModel):
    ...
    pretrained_model = None#"./pretrain_models/MobileNetV3_large_x0_5_pretrained"
    checkpoints = None
    save_infer_dir = None
    use_visualdl = False
...
if __name__ == '__main__':
    ...
    m.infer(r"D:\dev\github\ToddleOCR\doc\imgs\11.jpg","output/db_mv3/best_accuracy.pth")
