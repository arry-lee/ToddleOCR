...
class Model(ConfigModel):
    ...
    pretrained_model = None#"./pretrain_models/ResNet18_vd_pretrained"
    checkpoints = None
    save_infer_dir = None
    use_visualdl = False
    ...
    class Infer:
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False), DetResizeForTest(), NormalizeImage(
                scale="1./255.", mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225],
                order="hwc"), ToCHWImage(), KeepKeys(keep_keys=['image', 'shape'])]
...
def transmodel():
    ...
    paddle_params = paddle.load(r'D:\dev\.model\paddocr\ch_ppocr_server_v2.0_det_train\best_accuracy.pdparams')
    ...
    torch.save(d,r'D:\dev\.model\paddocr\ch_ppocr_server_v2.0_det_train\best_accuracy.pth')
...
if __name__ == '__main__':
    m = Model()
    # transmodel()
    m.infer(r"D:\dev\github\PaddleOCR\doc\imgs\11.jpg",r'D:\dev\.model\paddocr\ch_ppocr_server_v2.0_det_train\best_accuracy.pth')
