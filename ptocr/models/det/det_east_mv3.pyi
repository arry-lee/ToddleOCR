...
class Model(ConfigModel):
    ...
    class Loader:
        ...
        batch_size:1 = 16
        num_workers:2 = 8
    Transforms = _[DecodeImage(img_mode="BGR", channel_first=False),DetLabelEncode():...,EASTProcessTrain(image_shape=[512, 512], background_ratio=0.125, min_crop_side_ratio=0.1, min_text_size=10):,:DetResizeForTest(limit_side_len=2400, limit_type="max"),:NormalizeImage(scale="1./255.", mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225], order="hwc"),:ToCHWImage(),KeepKeys("image","score_map","geo_map","training_mask"):KeepKeys("image","shape","polys","ignore_tags"):...]