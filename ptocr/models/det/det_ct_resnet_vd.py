...
from ptocr.transforms.ct_process import GroupRandomCropPadding, ScaleAlignedShort, MakeCentripetalShift, MakeShrink, GroupRandomHorizontalFlip, RandomScale, GroupRandomRotate
...
class Model(ConfigModel):
    ...
    class Train:
        Dataset = _(SimpleDataSet, root="./train_data/total_text/train", label_file_list=['./train_data/total_text/train/train.txt'], ratio_list=[1.0])
    ...
    class Eval:
        Dataset = _(SimpleDataSet, root="./train_data/total_text/test", label_file_list=['./train_data/total_text/test/test.txt'], ratio_list=[1.0])
