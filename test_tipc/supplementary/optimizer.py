...
class LearningRateBuilder:
    ...
    def __init__(self, function="Linear", params={"lr": 0.1, "steps": 100, "end_lr": 0.0}):
...
class Momentum(object):
    ...
    def __init__(self, learning_rate, momentum, parameter_list=None, regularization=None, **args):
...
class OptimizerBuilder(object):
    ...
    def __call__(self, learning_rate, parameter_list=None):
        ...
        return opt(learning_rate=learning_rate, parameter_list=parameter_list, **self.params)()
