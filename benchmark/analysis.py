...
def parse_args():
    ...
    parser.add_argument("--filename", type=str, help="The name of log which need to analysis.")
    parser.add_argument("--log_with_profiler", type=str, help="The path of train log with profiler")
    parser.add_argument("--profiler_path", type=str, help="The path of profiler timeline log.")
    parser.add_argument("--keyword", type=str, help="Keyword to specify analysis data")
    parser.add_argument("--separator", type=str, default=None, help="Separator of different field in log")
    parser.add_argument("--position", type=int, default=None, help="The position of data field")
    parser.add_argument("--range", type=str, default="", help="The range of data field to intercept")
    ...
    parser.add_argument("--model_mode", type=int, default=-1, help="Analysis mode, default value is -1")
    parser.add_argument("--ips_unit", type=str, default=None, help="IPS unit")
    parser.add_argument("--model_name", type=str, default=0, help="training model_name, transformer_base")
    parser.add_argument("--mission_name", type=str, default=0, help="training mission name")
    parser.add_argument("--direction_id", type=int, default=0, help="training direction_id")
    parser.add_argument("--run_mode", type=str, default="sp", help="multi process or single process")
    parser.add_argument("--index", type=int, default=1, help="{1: speed, 2:mem, 3:profiler, 6:max_batch_size}")
