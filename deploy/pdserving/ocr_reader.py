...
class CharacterOps(object):
    ...
    def __init__(self, config):
        ...
        assert self.character_str is not None, "Nonsupport type of the character: {}".format(self.character_str)
        self.beg_str = "sos"
        self.end_str = "eos"
    ...
    def get_beg_end_flag_idx(self, beg_or_end):
        if self.loss_type == "attention":
            ...
            err = "error in get_beg_end_flag_idx when using the loss %s" % (self.loss_type)
            assert False, err
