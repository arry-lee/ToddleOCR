...
from torch.nn import CosineAnnealingLR, MobileNetV3
...
from ppocr.data.imaug.rec_img_aug import BaseDataAugmentation, ClsResizeImg
...
class Model(ConfigModel):
    ...
    LRScheduler = _(CosineAnnealingLR,T_max=None)
