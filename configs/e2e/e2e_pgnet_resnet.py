...
from ppocr.models.backbones.e2e_resnet_vd_pg import ResNet
from ppocr.models.necks.pg_fpn import PGFPN
from ppocr.models.heads.e2e_pg_head import PGHead
...
from ppocr.data.imaug.operators import DecodeImage, KeepKeys, ToCHWImage, NormalizeImage, E2EResizeForTest
from ppocr.data.imaug.label_ops import E2ELabelEncodeTrain, E2ELabelEncodeTest
...
class Model(ConfigModel):
    ...
    class Train:
        Dataset = _(PGDataSet, data_dir="./train_data/total_text/train", label_file_list=['./train_data/total_text/train/train.txt'], ratio_list=[1.0])
    ...
    class Eval:
        Dataset = _(PGDataSet, data_dir="./train_data/total_text/test", label_file_list=['./train_data/total_text/test/test.txt'])
