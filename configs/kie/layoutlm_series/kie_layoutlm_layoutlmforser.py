...
from torch.nn import LayoutLMForSer, VQASerTokenLayoutLMPostProcess, Linear
...
class Model(ConfigModel):
    ...
    class Train:
        ...
        transforms = _[
            ...
            VQATokenLabelEncode(
                contains_re=False, algorithm="LayoutLM", class_path="train_data/XFUND/class_list_xfun.txt"
            ),
