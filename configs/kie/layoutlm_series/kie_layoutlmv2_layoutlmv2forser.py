...
from torch.nn import VQASerTokenLayoutLMPostProcess, Linear, LayoutLMv2ForSer
...
class Model(ConfigModel):
    ...
    class Train:
        ...
        transforms = _[
            ...
            VQATokenLabelEncode(
                contains_re=False, algorithm="LayoutLMv2", class_path="train_data/XFUND/class_list_xfun.txt"
            ),
