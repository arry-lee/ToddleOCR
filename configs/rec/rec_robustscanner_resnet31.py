...
class Model(ConfigModel):
    ...
    class Train:
        ...
        transforms = _[
            ...
            SARLabelEncode(),
            RobustScannerRecResizeImg(image_shape=[3, 48, 48, 160], width_downsample_ratio=0.25, max_text_length=40),
            KeepKeys(keep_keys=["image", "label", "valid_ratio", "word_positons"]),
        ]
    ...
    class Eval:
        ...
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False),
            SARLabelEncode(),
            RobustScannerRecResizeImg(image_shape=[3, 48, 48, 160], max_text_length=40, width_downsample_ratio=0.25),
            KeepKeys(keep_keys=["image", "label", "valid_ratio", "word_positons"]),
        ]
