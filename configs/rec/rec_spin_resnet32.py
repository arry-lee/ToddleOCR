...
from torch.nn import GA_SPIN, Piecewise
from ppocr.modeling.backbones.rec_resnet_32 import ResNet32
from ppocr.modeling.necks.rnn import SequenceEncoder
from ppocr.modeling.heads.rec_spin_att_head import SPINAttentionHead
...
class Model(ConfigModel):
    ...
    LRScheduler = _(Piecewise, decay_epochs=[3, 4, 5], values=[0.001, 0.0003, 9e-05, 2.7e-05], clip_norm=5)
    ...
    class Train:
        ...
        transforms = _[
            ...
            SPINLabelEncode(),
            SPINRecResizeImg(image_shape=[100, 32], interpolation=2, mean=[127.5], std=[127.5]),
    ...
    class Eval:
        Dataset = _(
            SimpleDataSet, data_dir="./train_data/ic15_data", label_file_list=["./train_data/ic15_data/rec_gt_test.txt"]
        )
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False),
            SPINLabelEncode(),
