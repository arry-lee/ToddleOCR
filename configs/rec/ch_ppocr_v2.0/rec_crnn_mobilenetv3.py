...
class Model(ConfigModel):
    ...
    algorithm = 'CRNN'
    Transform = None
    Backbone = _(MobileNetV3, scale=0.5, model_name="small", small_stride=[1, 2, 2, 2])
    ...
    class Train:
        Dataset = _(SimpleDataSet, data_dir="./train_data/", label_files=['./train_data/train_list.txt'])
    ...
    class Eval:
        Dataset = _(SimpleDataSet, data_dir="./train_data", label_files=['./train_data/val_list.txt'])
