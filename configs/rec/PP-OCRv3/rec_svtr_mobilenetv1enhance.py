...
from ppocr.modeling.heads.rec_multi_head import MultiHead
...
from ppocr.data.imaug.rec_img_aug import RecAug, RecConAug, RecResizeImg
...
class Model(ConfigModel):
    ...
    Head = _(
        ...
        head_list=[
            {
                "class": "CTCHead",
                "Neck": {"class": "svtr", "dims": 64, "depth": 2, "hidden_dims": 120, "use_guide": True},
                "Head": {"fc_decay": 1e-05},
            },
