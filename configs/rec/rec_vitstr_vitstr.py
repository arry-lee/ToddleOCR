...
from ppocr.models.backbones.rec_vitstr import ViTSTR
...
class Model(ConfigModel):
    ...
    PostProcessor = _(ViTSTRLabelDecode,)
    class Train:
        Dataset = _(LMDBDataSet, data_dir="./train_data/data_lmdb_release/training/")
        transforms = _[DecodeImage(img_mode="BGR", channel_first=False), ViTSTRLabelEncode(ignore_index=0), GrayRecResizeImg(image_shape=[224, 224], resize_type="PIL", inter_type="Image.BICUBIC", scale=False), KeepKeys(keep_keys=['image', 'label', 'length'])]
