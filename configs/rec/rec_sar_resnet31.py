...
from ppocr.modeling.heads.rec_sar_head import SARHead
...
from ppocr.data.imaug.rec_img_aug import SARRecResizeImg
...
class Model(ConfigModel):
    ...
    class Train:
        Dataset = _(
            SimpleDataSet, label_file_list=["./train_data/train_list.txt"], data_dir="./train_data/", ratio_list=1.0
        )
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False),
            SARLabelEncode(),
            SARRecResizeImg(image_shape=[3, 48, 48, 160], width_downsample_ratio=0.25),
            KeepKeys(keep_keys=["image", "label", "valid_ratio"]),
        ]
