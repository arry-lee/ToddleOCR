...
from torch.nn import CT_Head, Linear
...
from ppocr.data.imaug.ct_process import MakeCentripetalShift, ScaleAlignedShort, RandomScale, GroupRandomCropPadding, GroupRandomHorizontalFlip, GroupRandomRotate, MakeShrink
