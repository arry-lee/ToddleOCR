...
from ppocr.losses.det_sast_loss import SASTLoss
...
class Model(ConfigModel):
    ...
    PostProcessor = _(
        SASTPostProcess, score_thresh=0.5, sample_pts_num=6, nms_thresh=0.2, expand_scale=1.2, shrink_ratio_of_width=0.2
    )
    ...
    class Train:
        ...
        transforms = _[
            ...
            DetLabelEncode(),
            SASTProcessTrain(
                image_shape=[512, 512], min_crop_side_ratio=0.3, min_crop_size=24, min_text_size=4, max_text_size=512
            ),
            KeepKeys(keep_keys=["image", "score_map", "border_map", "training_mask", "tvo_map", "tco_map"]),
        ]
    ...
    class Eval:
        Dataset = _(
            SimpleDataSet,
            data_dir="./train_data/",
            label_file_list=["./train_data/total_text_icdar_14pt/test_label_json.txt"],
        )
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False),
            DetLabelEncode(),
