...
from torch.nn import DRRGHead, Momentum, DecayLearningRate, DRRGTargets
...
class Model(ConfigModel):
    ...
    class Train:
        ...
        transforms = _[
            ...
            RandomRotatePolyInstances(rotate_ratio=0.5, max_angle=60, pad_with_fixed_color=False),
