...
class Model(ConfigModel):
    ...
    class Train:
        ...
        transforms = _[
            ...
            DetLabelEncode(),
            EASTProcessTrain(image_shape=[512, 512], background_ratio=0.125, min_crop_side_ratio=0.1, min_text_size=10),
            KeepKeys(keep_keys=["image", "score_map", "geo_map", "training_mask"]),
        ]
