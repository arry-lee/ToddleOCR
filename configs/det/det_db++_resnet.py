...
class Model(ConfigModel):
    ...
    PostProcessor = _(
        DBPostProcess, thresh=0.3, box_thresh=0.5, max_candidates=1000, unclip_ratio=1.5, det_box_type="quad"
    )
    ...
    class Train:
        Dataset = _(
            SimpleDataSet,
            data_dir="./train_data/",
            label_file_list=["./train_data/TD_TR/TD500/train_gt_labels.txt", "./train_data/TD_TR/TR400/gt_labels.txt"],
            ratio_list=[1.0, 1.0],
        )
        transforms = _[
    ...
    class Eval:
        Dataset = _(
            SimpleDataSet, data_dir="./train_data/", label_file_list=["./train_data/TD_TR/TD500/test_gt_labels.txt"]
        )
        transforms = _[
            DecodeImage(img_mode="BGR", channel_first=False),
            DetLabelEncode(),
