...
实验中，&gamma;取值为2, &alpha;= 1, 具体实现见:  [rec_ctc_loss.py](../../toddleocr/loss/ctc.py)
...
实验中，λ = 0.1.  ACE loss实现代码见:  [ace_loss.py](../../toddleocr/loss/ace.py)
...
实验中，我们设置λ=0.25. center_loss实现代码见:  [center_loss.py](../../toddleocr/loss/center.py)
...
统一的融合方案见如下文件：  [rec_enhanced_ctc_loss.py](../../toddleocr/loss/rec_enhanced_ctc_loss.py)
