...
class DistillationDMLLoss(DMLLoss):
    ...
    def __init__(self, model_name_pairs=None, act=None, use_log=False, key=None, multi_head=False, dis_head='ctc', maps_name=None, name='dml'):
        super().__init__(act=act, use_log=use_log)
        if model_name_pairs is None:
            model_name_pairs = []
...
class DistillationCTCLoss(CTCLoss):
    ...
    def __init__(self, model_name_list=None, key=None, multi_head=False, name='loss_ctc'):
        super().__init__()
...
class DistillationSARLoss(SARLoss):
    ...
    def __init__(self, model_name_list=None, key=None, multi_head=False, name='loss_sar', **kwargs):
        if model_name_list is None:
            model_name_list = []
...
class DistillationDBLoss(DBLoss):
    ...
    def __init__(self, model_name_list=None, balance_loss=True, main_loss_type='DiceLoss', alpha=5, beta=10, ohem_ratio=3, eps=1e-06, name='db', **kwargs):
        super().__init__()
        if model_name_list is None:
            model_name_list = []
        self.model_name_list = model_name_list
...
class DistillationDilaDBLoss(DBLoss):
    ...
    def __init__(self, model_name_pairs=None, key=None, balance_loss=True, main_loss_type='DiceLoss', alpha=5, beta=10, ohem_ratio=3, eps=1e-06, name='dila_dbloss'):
        super().__init__()
        if model_name_pairs is None:
            model_name_pairs = []
    ...
    def forward(self, predicts, batch):
        ...
        for (idx, pair) in enumerate(self.model_name_pairs):
            ...
            th_shrink_maps = th_shrink_maps.numpy() > 0.3
