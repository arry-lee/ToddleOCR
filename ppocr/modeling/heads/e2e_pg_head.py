...
class PGHead(nn.Module):
    ...
    def __init__(self, in_channels, character_dict_path="ppocr/utils/ic15_dict.txt", **kwargs):
        ...
        self.conv1 = nn.Conv2d(in_channels=128, out_channels=1, kernel_size=3, stride=1, padding=1, groups=1, weight_attr=ParamAttr(name="conv_f_score{}".format(4)), bias=False)
        ...
        self.conv2 = nn.Conv2d(in_channels=128, out_channels=4, kernel_size=3, stride=1, padding=1, groups=1, weight_attr=ParamAttr(name="conv_f_boder{}".format(4)), bias=False)
        ...
        self.conv3 = nn.Conv2d(in_channels=256, out_channels=character_length, kernel_size=3, stride=1, padding=1, groups=1, weight_attr=ParamAttr(name="conv_f_char{}".format(6)), bias=False)
        ...
        self.conv4 = nn.Conv2d(in_channels=128, out_channels=2, kernel_size=3, stride=1, padding=1, groups=1, weight_attr=ParamAttr(name="conv_f_direc{}".format(4)), bias=False)
