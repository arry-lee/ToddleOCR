...
def add_profiler_step(options_str=None):
    ...
    if _profiler_step_id == _profiler_options["batch_range"][0]:
        torch.utils.profiler.start_profiler(_profiler_options["state"], _profiler_options["tracer_option"])
    elif _profiler_step_id == _profiler_options["batch_range"][1]:
        torch.utils.profiler.stop_profiler(_profiler_options["sorted_key"], _profiler_options["profile_path"])
