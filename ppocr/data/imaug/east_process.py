...
class EASTProcessTrain(object):
    ...
    def generate_quad(self, im_size, polys, tags):
        ...
        for poly_idx, poly_tag in enumerate(zip(polys, tags)):
            ...
            for pno in range(4):
                ...
                geo_map[y_in_poly, x_in_poly, geo_channel_beg] = x_in_poly - poly[pno, 0]
                geo_map[y_in_poly, x_in_poly, geo_channel_beg + 1] = y_in_poly - poly[pno, 1]
    ...
    def crop_foreground_infor(self, im, text_polys, text_tags):
        ...
        score_map, geo_map, training_mask = self.generate_quad((new_h, new_w), text_polys, text_tags)
        return im, score_map, geo_map, training_mask
