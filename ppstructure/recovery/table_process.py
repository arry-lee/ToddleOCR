...
def get_table_rows(table_soup):
    table_row_selectors = ["table > tr", "table > thead > tr", "table > tbody > tr", "table > tfoot > tr"]
...
class HtmlToDocx(HTMLParser):
    def __init__(self):
        ...
        self.table_row_selectors = ["table > tr", "table > thead > tr", "table > tbody > tr", "table > tfoot > tr"]
