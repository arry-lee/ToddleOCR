...
class TextDetector:
    def __init__(self, args):
        ...
        if self.det_algorithm == "DB":
            ...
            pre_process_list[0] = {"DetResizeForTest": {"resize_long": args.det_limit_side_len}}
...
if __name__ == "__main__":
    ...
    for idx, image_file in enumerate(image_file_list):
        ...
        for index, img in enumerate(imgs):
            ...
            if len(imgs) > 1:
                logger.info("{}_{} The predict time of {}: {}".format(idx, index, image_file, elapse))
            else:
                logger.info("{} The predict time of {}: {}".format(idx, image_file, elapse))
            ...
            img_path = os.path.join(draw_img_save_dir, "det_res_{}".format(os.path.basename(save_file)))
