...
from toddleocr.loss.table_master import TableMasterLoss
from toddleocr.metrics.table import TableMetric
from toddleocr.modules.backbones.table_master_resnet import TableResNetExtra
...
class Model(ConfigModel):
    ...
    postprocessor = TableMasterLabelDecode(
        box_shape="pad", merge_no_span_structure=True
    )
    ...
    Transforms = _[
        ...
        NormalizeImage(
            scale="1./255.", mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5], order="hwc"
        ),
        ToCHWImage(),
