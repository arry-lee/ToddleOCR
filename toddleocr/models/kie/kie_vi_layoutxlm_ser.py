...
class Model(ConfigModel):
    ...
    Backbone = _(
        LayoutXLMForSer,
        pretrained=MODEL_DIR / "vi-layoutxlm-base-uncased",
        checkpoints=None,
        mode="vi",
        num_classes=7
    )
    ...
    class Data:
        ...
        label_file_list: "XFUND/zh_val/val.json" = "../../../train_data/XFUND/zh_train/train.json"
...
def _t():
    ...
    transmodel(MODEL_DIR / "ser_vi_layoutxlm_xfund_pretrained/best_accuracy/model_state.pdparams",
...
if __name__ == '__main__':
    # _t()
    m = Model(pretrained=MODEL_DIR / "ser_vi_layoutxlm_xfund_pretrained/best_accuracy/model_state.pt")
    m.ser_one_image(r"D:\dev\github\ToddleOCR\train_data\XFUND\zh_val\image\zh_val_28.jpg", output='output1.jpg')
