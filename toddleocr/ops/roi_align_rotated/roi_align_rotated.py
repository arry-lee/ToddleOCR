...
custom_ops = load(
    name="custom_jit_ops",
    sources=[
        "D:/dev/github/ToddleOCR/toddleocr/ops/roi_align_rotated/roi_align_rotated.cc",
        "D:/dev/github/ToddleOCR/toddleocr/ops/roi_align_rotated/roi_align_rotated.cu",
    ],
)
